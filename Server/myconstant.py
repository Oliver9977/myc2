...
class myconstant():
    def __init__(self):
        ...
        self.CMD_PIPE_STAGER_TOOLS_AUTOLIST = [self.CMD_PIPE_STAGER_TOOLS_IF64BIT,self.CMD_PIPE_STAGER_TOOLS_GETNETVERSION,self.CMD_PIPE_STAGER_TOOLS_GETNETVERSION2,

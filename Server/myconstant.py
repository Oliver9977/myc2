...
class myconstant():
    def __init__(self):
        ...
        self.CMD_PIPE_STAGER_TOOLS_DOWNLOAD = "download"
        ...
        self.CMD_PIPE_STAGER_TOOLS_PSREMOTE = "psremote"
        self.CMD_PIPE_STAGER_TOOLS_PSJUMP = "psjump"
        self.CMD_PIPE_STAGER_TOOLS_PSJUMP_EXE = "psjump-exe"
        ...
        self.CMD_PIPE_STAGER_TOOLS_AUTOLIST = [self.CMD_BACK,self.CMD_PIPE_STAGER_GET_HISTORY,self.CMD_PIPE_STAGER_VERBOSE,self.CMD_PIPE_STAGER_TOOLS_IF64BIT,self.CMD_PIPE_STAGER_TOOLS_GETNETVERSION,self.CMD_PIPE_STAGER_TOOLS_GETNETVERSION2,
                                                ...
                                                self.CMD_PIPE_STAGER_TOOLS_LS,self.CMD_PIPE_STAGER_TOOLS_DOWNLOAD,self.CMD_PIPE_STAGER_TOOLS_SHARPHOUND3,self.CMD_PIPE_STAGER_TOOLS_SPAWN_PS,self.CMD_PIPE_STAGER_TOOLS_PSRESET,
                                                self.CMD_PIPE_STAGER_TOOLS_PSEXEC,self.CMD_PIPE_STAGER_TOOLS_PSREMOTE,self.CMD_PIPE_STAGER_TOOLS_PSJUMP,self.CMD_PIPE_STAGER_TOOLS_PSJUMP_EXE,
